...
public class Sender {
	...
	/**
	 * Auxiliary method that simulates an unrealiable environment where many packets
	 * get lost, are sent duplicated or suffer random bit modifications.
	 * 
	 * @param packet to pass through the unreliable environment
	 * @return the potentially modified packet
	 */
